    ...
    public function run(): void
    {
        $features = [
            ...
            [
                ...
                'slug' => Str::slug('Heavy Equipment'),
                'meta_title' => 'Heavy Equipment Transport Services',
                'meta_description' => 'Dependable transport solutions for construction machinery, farm equipment, and industrial vehicles — safely and on schedule.',
                'details' => '
                    <h2>Heavy Equipment Transport Services</h2>
                    <p>Transporting heavy machinery requires precision, experience, and the right equipment. Our heavy equipment transport service specializes in moving oversized and overweight vehicles across cities or across the country with utmost care.</p>

                    <h3>What is Heavy Equipment Transport?</h3>
                    <p>This service is designed for large machines like bulldozers, excavators, tractors, and other industrial vehicles. We utilize specialized trailers and experienced operators to ensure safe and compliant transportation.</p>

                    <h3>What We Offer</h3>
                    <ul>
                        <li><strong>Specialized Trailers:</strong> Lowboys, flatbeds, step decks, and RGNs tailored for oversized loads.</li>
                        <li><strong>Permitting & Compliance:</strong> We handle all local, state, and federal permits and DOT compliance.</li>
                        <li><strong>On-Site Pickup & Delivery:</strong> Pickup and drop-off from job sites, farms, or industrial areas.</li>
                        <li><strong>Experienced Drivers:</strong> Skilled in handling heavy-duty cargo and complex loading/unloading.</li>
                        <li><strong>Insurance Coverage:</strong> Comprehensive insurance for peace of mind.</li>
                    </ul>

                    <h3>When You Need Heavy Equipment Shipping</h3>
                    <p>Whether it\'s a one-time move or ongoing projects, we serve:</p>
                    <ul>
                        <li>Construction companies</li>
                        <li>Agricultural operations</li>
                        <li>Mining and excavation businesses</li>
                        <li>Heavy industry contractors</li>
                    </ul>

                    <blockquote>
                        <p><em>"Our heavy equipment transport is engineered for power, precision, and peace of mind."</em></p>
                    </blockquote>

                    <h3>Let’s Move Your Machinery Safely</h3>
                    <p>Get in touch for a free quote and see how we make heavy equipment shipping simple and secure — no matter the size or distance.</p>
                ',
                'icon' => 'fa-truck-loading',
                'main_image' => 'frontAssets/img/heavy-equipment.jpg',
                'is_active' => 'active',
            ],
            [
                'name' => 'General Freight',
                'slug' => Str::slug('General Freight'),
                'meta_title' => 'General Freight Transportation Services',
                'meta_description' => 'Efficient and reliable general freight transport services tailored to your business needs across local and interstate routes.',
                'details' => '
                    <h2>General Freight Shipping Services</h2>
                    <p>Our general freight transportation is perfect for moving goods, materials, and packages with speed, safety, and professionalism. Whether it’s LTL or FTL, we’ve got you covered.</p>

                    <h3>What is General Freight?</h3>
                    <p>General freight includes a wide variety of non-specialized goods that need to be moved efficiently — from consumer products to raw materials, and everything in between.</p>

                    <h3>Service Features</h3>
                    <ul>
                        <li><strong>Flexible Load Options:</strong> Full Truckload (FTL) or Less-than-Truckload (LTL).</li>
                        <li><strong>Route Optimization:</strong> Fastest and most cost-effective delivery planning.</li>
                        <li><strong>Real-Time Updates:</strong> Live tracking and 24/7 communication with dispatch.</li>
                        <li><strong>Secure Handling:</strong> Proper packaging and protection protocols.</li>
                        <li><strong>Nationwide Reach:</strong> Serving both local and cross-country needs.</li>
                    </ul>
                    ...
                    <ul>
                        ...
                        <li>Manufacturing</li>
                        <li>Food & Beverage (dry goods)</li>
                        <li>Medical Supplies</li>
                        <li>Wholesale Distributors</li>
                    </ul>

                    <blockquote>
                        <p><em>"From single pallets to full truckloads, we deliver consistency, transparency, and on-time results."</em></p>
                    </blockquote>

                    <h3>Get Started with Freight Shipping</h3>
                    <p>Request a quote today and partner with a logistics provider that puts your cargo and your time first.</p>
                ',
                'icon' => 'fa-boxes-packing',
                'main_image' => 'frontAssets/img/general-freight.jpg',
                'is_active' => 'active',
            ],
            ...
            //     'meta_title' => 'End-to-End Logistics Solutions',
            //     'meta_description' => 'Streamline your supply chain with our full-service logistics solutions — warehousing, distribution, and transportation under one roof.',
            //     'details' => '
            //         <h2>Comprehensive Logistics Services</h2>
            //         <p>We provide integrated logistics solutions tailored to meet your business goals. From transportation to warehousing and last-mile delivery, our team ensures smooth and cost-effective operations.</p>

            //         <h3>Our Logistics Capabilities</h3>
            //         <ul>
            //             <li><strong>Inventory Management:</strong> Real-time inventory control with intelligent warehouse solutions.</li>
            //             <li><strong>Distribution:</strong> Streamlined delivery across multiple channels and regions.</li>
            //             <li><strong>Supply Chain Optimization:</strong> Data-driven route planning and fulfillment.</li>
            //             <li><strong>Custom Solutions:</strong> Flexible services based on industry and product types.</li>
            //             <li><strong>Technology Integration:</strong> ERP/WMS system integration for real-time visibility.</li>
            //         </ul>
            ...
            //         <blockquote>
            //             <p><em>"From the warehouse to the customer’s door — our logistics keep your business moving forward."</em></p>
            //         </blockquote>

            //         <h3>Optimize Your Logistics Today</h3>
            //         <p>Let’s build a logistics solution around your business. Contact us to learn how we simplify complex supply chains with speed and efficiency.</p>
            //     ',
            //     'icon' => 'fa-network-wired',
            //     'main_image' => 'frontAssets/img/service3.jpg',
            //     'is_active' => 'active',
            // ],

            [
                'name' => 'Auto Shipping',
                'slug' => Str::slug('Auto Shipping'),
                'meta_title' => 'Reliable Auto Shipping Services',
                'meta_description' => 'Fast, safe, and affordable auto shipping for all vehicle types, anywhere in the country. Open or enclosed carrier options available.',
                'details' => '
                    <h2>Nationwide Auto Shipping Services</h2>
                    <p>We provide dependable and hassle-free auto transport services for individuals, dealerships, and businesses alike. Whether moving across the state or the country, we handle your car with the utmost care.</p>

                    <h3>Why Choose Our Auto Shipping?</h3>
                    <ul>
                        <li><strong>Open & Enclosed Carriers:</strong> Choose your preferred level of protection and price.</li>
                        <li><strong>Door-to-Door Delivery:</strong> Full-service transport from your location to your destination.</li>
                        <li><strong>Licensed & Insured:</strong> DOT-compliant and fully insured for your peace of mind.</li>
                        <li><strong>Fast Turnaround:</strong> Flexible scheduling with quick pickup options.</li>
                        <li><strong>Vehicle Inspection:</strong> Pre and post-shipment inspections included.</li>
                    </ul>

                    <h3>Vehicle Types We Transport</h3>
                    <ul>
                        <li>Sedans, SUVs, and trucks</li>
                        <li>Motorcycles and ATVs</li>
                        <li>Luxury and classic cars</li>
                        <li>Electric vehicles</li>
                        <li>Fleet vehicles for dealerships</li>
                    </ul>

                    <blockquote>
                        <p><em>"Auto shipping made easy — because your car deserves the best journey, every time."</em></p>
                    </blockquote>

                    <h3>Ready to Ship Your Vehicle?</h3>
                    <p>Contact us today for a free quote and experience auto transport done right — fast, affordable, and professional.</p>
                ',
                'icon' => 'fa-car-side',
                'main_image' => 'frontAssets/img/open-carrier.jpg',
                'is_active' => 'active',
