    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card mb-6">
            <div class="card-body pt-4">
                <form method="POST" action="{{ route('dashboard.team.update', $team->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')

                    <div class="row p-5">
                        <h3>{{ __('Edit Team Member') }}</h3>
                        ...
                        <div class="mb-4 col-md-6">
                            ...
                            <input class="form-control @error('name') is-invalid @enderror" type="text" id="name"
                                ...
                                placeholder="{{ __('Enter team member name') }}" autofocus />
                            @error('name')
                        ...
                        <div class="mb-4 col-md-6">
                            ...
                            @if ($team->image)
                                <img src="{{ asset($team->image) }}" alt="Team Member Image" class="mt-2" width="120">
                            @endif
                            @error('image')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="mb-4 col-md-12">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" required
                                placeholder="{{ __('Enter description') }}" cols="20" rows="10">{{ $team->description }}</textarea>
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4 col-md-12">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="url" id="facebook" name="facebook" class="form-control @error('facebook') is-invalid @enderror"
                                    value="{{ old('facebook', $team->facebook) }}" placeholder="i.e. https://facebook.com/" />
                                @error('facebook')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="url" id="linkedin" name="linkedin" class="form-control @error('linkedin') is-invalid @enderror"
                                    value="{{ old('linkedin', $team->linkedin) }}" placeholder="i.e. https://linkedin.com/" />
                                @error('linkedin')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="url" id="twitter" name="twitter" class="form-control @error('twitter') is-invalid @enderror"
                                    value="{{ old('twitter', $team->twitter) }}" placeholder="i.e. https://x.com/" />
                                @error('twitter')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="url" id="instagram" name="instagram" class="form-control @error('instagram') is-invalid @enderror"
                                    value="{{ old('instagram', $team->instagram) }}" placeholder="i.e. https://instagram.com/" />
                                @error('instagram')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="mt-2">
                            <button type="submit" class="btn btn-primary me-3">{{ __('Update Team Member') }}</button>
                        </div>
                </form>
            </div>
        </div>
