            ...
            <div class="row p-5">
                ...
                <div class="mb-4 col-md-4">
                    ...
                    <div class="input-group input-group-merge">
                        <span class="input-group-text country_code">US (+1)</span>
                ...
                {{-- <div class="mb-4 col-md-12">
                    ...
                    <input type="text" class="form-control @error('google_map') is-invalid @enderror" id="google_map" name="google_map" value="{{$companySetting->google_map}}" placeholder="i.e. https://www.google.com/maps/embed?pb=" maxlength="6" />
                    @error('google_map')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
